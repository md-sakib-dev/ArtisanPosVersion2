...
interface ReturnItem extends FactoryProduct {
  id: number;
  returnQty: number;
}
...
function ViewChallanModal({
  ...
  const totalReturnQty = items.reduce(
  ...
  return (
    <div
      ...
      "
      style={{
        animation: "fr-fade 150ms ease-out",
      }}
      onMouseDown={(e) => {
    ...
    >
      ...
      <div
        ...
        "
        style={{
          animation: "fr-pop 180ms ease-out",
        }}
      >
...
function FactoryReturn() {
  ...
  const [returnQtyInput, setReturnQtyInput] =
    useState("1");
  ...
  const handleAdd = () => {
    ...
    const quantity =
      Math.floor(Number(returnQtyInput) || 0);
    ...
    ">
      ...
      ">
        ...
        <div className="
          ...
          gap-2
          sm:grid-cols-2
          xl:grid-cols-[minmax(0,1fr)_minmax(0,1.6fr)_minmax(0,0.7fr)_auto]
        ">
        ...
        {/* ROW 2 — AUTO-POPULATED PRODUCT INFO */}
        ...
        <div className="
          ...
          grid-cols-1
          gap-2
          md:grid-cols-[minmax(0,1.2fr)_minmax(0,1.6fr)_minmax(0,0.7fr)]
        ">
